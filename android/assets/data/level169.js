...

{
        ...
        mMirrors: [{name:"m",type:"S",shape:"rect",x:85,y:200,w:90,h:25, angle:90, fixedRotation:1, fixedPosition:0}] 
    }, 
        ...
        mMirrors: [{name:"m",type:"S",shape:"rect",x:140,y:300,w:90,h:25, angle:20, fixedRotation:1, fixedPosition:0}, 
                   {name:"m",type:"S",shape:"rect",x:400,y:50,w:90,h:25, angle:0, fixedRotation:0, fixedPosition:1}], 
    },

    {
        ...
        mMirrors: [{name:"m",type:"S",shape:"rect",x:70,y:300,w:90,h:25, angle:85, fixedRotation:1, fixedPosition:0},
...

    {
        ...
        mTarget:{name:"e", type:"S", shape:"circle", x:590, y:300, r:40},
        mMirrors: [{name:"m",type:"S",shape:"rect",x:300,y:300,w:90,h:25, angle:65, fixedRotation:1, fixedPosition:0}],
...

    {
        ...
        mMirrors: [{name:"m",type:"S",shape:"rect",x:600,y:180,w:90,h:25, angle:80, fixedRotation:1, fixedPosition:1}],
